# Programacion 3 - Proyecto: Sistema de Ventas
...
El programa esta listo para compílar mediante Visual Studio 2022, sin embargo, necesitarás tener la base de datos previamente creada con las tablas correspondientes... Se le adjuntará un query donde traerá los scripts de para la creacion de la base de datos, tablas y los procedimientos almacenados para poder realizar el proceso de facturacion y devolucion de facturas.

El proyecto se ejecuta en el proyecto de "CAPA_PRESENTACION"
